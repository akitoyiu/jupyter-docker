7# Configuration file for jupyter-notebook.
...
#  Default: ''
c.NotebookApp.allow_origin = 'https://jn.shinix.com'
...
#  Choices: any of ['sha3_384', 'sha384', 'sha3_224', 'blake2s', 'sha224', 'blake2b', 'sha512', 'sha3_512', 'sha256', 'sha3_256', 'md5', 'sha1']
#  Default: 'sha256'
